...
Widgets consume :mod:`asdecided.explorer.state` types only. Meaning never depends
...
# single definition lives in asdecided.explorer.state so the health screen agrees.
