...
(:mod:`asdecided.explorer.screens.main`) with the rac-lantern theme as the curated
default. This is the first module on the import path that requires Textual;
:mod:`asdecided.explorer.launch` imports it lazily so the base install works
...
from asdecided.explorer.theme import DECIDED_THEMES, THEME_NAME
