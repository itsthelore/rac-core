...
Scores a :class:`~asdecided.core.models.Product` against the artifact schemas in
:mod:`asdecided.core.artifacts` and picks the best-fit type (or Unknown). This is a pure,
