...
The per-file byte cap is overridable via ``DECIDED_MAX_FILE_BYTES`` for repositories
...
# DECIDED_MAX_FILE_BYTES. A non-positive or unparseable override falls back to the
# default rather than disabling the guard.
DEFAULT_MAX_FILE_BYTES = 1 << 20  # 1 MiB
_MAX_FILE_BYTES_ENV = "DECIDED_MAX_FILE_BYTES"
