...
`decided schema` answers "what should this artifact look like?" without requiring an
existing file. It consumes :mod:`asdecided.core.artifacts` as the single source of truth and
