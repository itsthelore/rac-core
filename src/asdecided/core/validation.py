"""Validate a :class:`~asdecided.core.models.Product` against RAC's format rules.

Returns a flat list of :class:`~asdecided.core.models.Issue` objects (errors and warnings);
...
# ``.decided/config.yaml`` by the services layer and passed into ``validate``; core
