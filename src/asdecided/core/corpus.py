...
same three steps: discover files (:func:`asdecided.core.fs.find_markdown_files`),
parse each into a :class:`~asdecided.core.models.Product`
(:func:`asdecided.core.markdown.parse_file`), and classify the result
(:func:`asdecided.core.classification.classify`). v0.7.14 extracts that loop here —
