...
``asdecided.templates.portal`` together with its provenance manifest
...
from asdecided.services.export import CorpusExport
...
class PortalShellMissing(RACError):
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            "asdecided-portal-shell.html); the RAC installation appears to be broken"
        )
...
def _load_shell() -> str:
    resource = resources.files("asdecided.templates").joinpath("portal/asdecided-portal-shell.html")
    try:
