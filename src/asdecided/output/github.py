"""GitHub-oriented rendering for `decided watchkeeper --format github` (v0.12.2).
...
from asdecided.services.compare import CHANGE_ADDED, CHANGE_MODIFIED, CHANGE_REMOVED
from asdecided.services.intent import SEVERITY_WARNING
