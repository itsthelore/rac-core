...
Starter templates for missing sections (``decided improve --template``) and full
artifact scaffolds (``decided schema --template``). Templates are deterministic,
schema-derived Markdown — never AI-generated content (ADR-002).
"""

from __future__ import annotations

from asdecided.core.schema import SchemaReference, template_sections
