"""Compare two :class:`~asdecided.core.models.Product` ASTs and classify the changes.
...
from asdecided.core.models import Diff, Product, Requirement, RequirementChange
