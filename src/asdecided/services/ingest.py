...
`decided ingest <file>` turns an existing document (DOCX today; HTML/PDF later) into
...
class MarkItDownConverter:
    ...
    Imported lazily so the core install (and `decided ingest file.md`) works without
