...
Coverage answers a different question from `decided doctor`'s integrity checks: not
...
before anything applies it. The report stays out of the `decided gate` enforcement
