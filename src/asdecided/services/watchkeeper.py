...
:mod:`asdecided.services.revisions` — loads both states, and assembles the report
the ``decided watchkeeper`` command renders. Watchkeeper consumes Core
...
from asdecided.core.models import Diff
...
from asdecided.services.relationships import RelationshipSummary
from asdecided.services.revisions import materialized_revision, repository_root
