...
`decided inspect <file>` answers, for a single document: *what kind of artifact is
...
when present. `decided inspect <dir>` aggregates the type across a directory into
...
delegated to :mod:`asdecided.core.classification` (the shared, AI-optional heuristic).
"""
