"""Metadata migration — `decided migrate metadata` (v0.7.13).
...
against the repository index — the same contract as ``decided new``.
"""
...
def migrate_metadata(
    ...
    Raises :class:`~asdecided.services.create.MissingRepositoryConfig` when no
    repository key is established and
    :class:`~asdecided.services.create.IdGenerationExhausted` on persistent ID
    collisions.
    """
