...
`design/lantern.png` (16×24) is a **placeholder** generated by
`scripts/make-lantern.mjs` from token colours. The real mascot — the
hooded pixel-art lamplighter holding the lantern, visible in the mockup
— is a human deliverable and replaces it when available.
