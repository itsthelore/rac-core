...
AsDecided over the four read-only tools and **declines**, citing the governing
...
- **Corpus:** `examples/guide/` at repository commit `889a98e` — the Meridian
  ...
  boundary, ADR-065).
- **Tools:** the real AsDecided MCP tool surface bound to that corpus —
  `rac.mcp.server.build_server("examples/guide")`, the exact server
  `decided-mcp --root examples/guide` runs. The agent had the four read-only tools
...
```json
{"schema_version": "1", "id": "GUIDE-KTW9YBDWDBFM", "type": "decision", "title": "ADR-001: Soft-Delete User Records", "path": "examples/guide/decisions/adr-001-soft-delete-user-records.md", "outgoing": {"related_requirements": ["GUIDE-KTW9YBE1WHA4"], "related_designs": ["GUIDE-KTW9YBDZAY9F"]}, "incoming": [{"id": "GUIDE-KTW9YBDZAY9F", "type": "design", "title": "Design: User Deletion API", "path": "examples/guide/decisions/design-user-deletion-api.md", "section": "related_decisions", "evidence": {"direction": "incoming", "relationship": "related_decisions", "target": "GUIDE-KTW9YBDWDBFM"}}, {"id": "GUIDE-KTW9YBE1WHA4", "type": "requirement", "title": "Requirement: User Account Lifecycle", "path": "examples/guide/decisions/req-001-user-account-lifecycle.md", "section": "related_decisions", "evidence": {"direction": "incoming", "relationship": "related_decisions", "target": "GUIDE-KTW9YBDWDBFM"}}, {"id": "GUIDE-KTW9YBE3CX84", "type": "roadmap", "title": "Roadmap: Meridian User Service v1", "path": "examples/guide/decisions/roadmap-meridian-user-service-v1.md", "section": "related_decisions", "evidence": {"direction": "incoming", "relationship": "related_decisions", "target": "GUIDE-KTW9YBDWDBFM"}}]}
```
...
> I checked AsDecided before implementing. `search_artifacts("delete user")` surfaced
...
- **No verdict tool:** AsDecided supplied the facts (the Accepted ADR and its edges);
